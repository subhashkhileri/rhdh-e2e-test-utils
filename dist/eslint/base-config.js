        ...
        // Playwright test files
        {
            ...
            rules: {
                ...
                "no-restricted-syntax": [
                    "error",
                    {
                        selector: "CallExpression[callee.property.name='fixme'][callee.object.property.name='describe'][callee.object.object.name='test']",
                        message: "test.describe.fixme() is not valid. Use test.fixme() on individual tests instead.",
                    },
                ],
